...
* **Year-over-Year (YoY) Percentage Change:**
  `YoY Growth Rate (%) = [(Current Value - Prior Year Value) / Prior Year Value] × 100`
...
3. **2023–2026 Disinflation & Real Expansion:** As headline inflation cooled toward 2.4%–3.0% and nominal wage growth stabilized at 3.6%–4.0%, real purchasing power returned to positive territory (**+0.8% to +1.3%**).
